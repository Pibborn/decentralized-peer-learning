...
#SBATCH --job-name=27_04_22_fullinfo_1_agent_Walker2DPyBulletEnv-v0      # Job name
...
wandb offline
srun python run_fullinfo.py  --save-name fullinfo_1_agent_Walker2DPyBulletEnv-v0_27_04_22 \
