...
#SBATCH --job-name=08_04_22_fullinfo_4_agent_Pendulum-v0      # Job name
...
wandb offline
srun python run.py  --save-name fullinfo_4_agent_Pendulum-v0_08_04_22  --env Pendulum-v0  --agent-count 4 \
