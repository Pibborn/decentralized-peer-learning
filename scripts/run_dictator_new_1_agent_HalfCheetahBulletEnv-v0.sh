...
#SBATCH --job-name=27_04_22_dictator_new_1_agent_HalfCheetahBulletEnv-v0      # Job name
...
wandb offline
srun python run_dictator_new.py --save-name dictator_new_1_agent_HalfCheetahBulletEnv-v0_27_04_22 \
  --job_id %j --env HalfCheetahBulletEnv-v0 --agent-count 1 --batch-size 256 --buffer-size 300_000 \
