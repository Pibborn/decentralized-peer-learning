...
#SBATCH --job-name=peer_3_agent_Walker2DPyBulletEnv-v0      # Job name
...
wandb offline
srun python run_peer.py  --save-name peer_3_agent_Walker2DPyBulletEnv-v0  --job_id %j --env Walker2DPyBulletEnv-v0  --agent-count 3 \
