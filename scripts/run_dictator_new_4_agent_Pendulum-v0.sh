...
#SBATCH --job-name=27_04_22_dictator_4_agent_Pendulum-v0      # Job name
...
wandb offline
srun python run_dictator_new.py  --save-name dictator_new_4_agent_Pendulum-v0_27_04_22 \
 --job_id %j --env Pendulum-v0  --agent-count 4 --eval-interval 500 --batch-size 256 \
