...
#SBATCH --job-name=27_04_22_fullinfo_1_agent_Pendulum-v0      # Job name
...
#SBATCH --time=1:00:00           # Run time (hh_mm_ss) - 30 seconds
...
wandb offline
srun python run_fullinfo.py --save-name fullinfo_1_agent_Pendulum-v0_27_04_22 \
