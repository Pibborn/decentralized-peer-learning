...
#SBATCH --job-name=dictator_new_4_agent_HalfCheetahBulletEnv-v0      # Job name
...
wandb offline
srun python run_dicator_new.py  --save-name dictator_new_4_agent_HalfCheetahBulletEnv-v0  --env HalfCheetahBulletEnv-v0  --agent-count 4 \
