...
#SBATCH --job-name=27_04_22_dictator_new_4_agent_Walker2DPyBulletEnv-v0      # Job name
...
wandb offline
srun python run_dictator_new.py --save-name dictator_new_4_agent_Walker2DPyBulletEnv-v0_27_04_22 \
  --job_id %j --env Walker2DPyBulletEnv-v0 --agent-count 4 --batch-size 256 --buffer-size 300_000 --steps 1_000_000 \
