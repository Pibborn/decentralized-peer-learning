...
#SBATCH --job-name=27_04_22_dictator_new_1_agent_Walker2DPyBulletEnv-v0      # Job name
...
#SBATCH --time=12:00:00           # Run time (hh_mm_ss) - 30 seconds
...
wandb offline
srun python run_dictator_new.py --save-name dictator_new_1_agent_Walker2DPyBulletEnv-v0_27_04_22 \
  --job_id %j --env Walker2DPyBulletEnv-v0 --agent-count 1 --batch-size 256 --buffer-size 300_000 --steps 1_000_000 \
