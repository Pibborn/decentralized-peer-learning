...
#SBATCH --job-name=peer_4_agent_HalfCheetahBulletEnv-v0      # Job name
...
wandb offline
srun python run_peer.py  --save-name peer_4_agent_HalfCheetahBulletEnv-v0  --env HalfCheetahBulletEnv-v0  --agent-count 4 \
