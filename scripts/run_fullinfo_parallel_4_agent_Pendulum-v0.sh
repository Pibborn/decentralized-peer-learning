...
wandb offline
srun python run_fullinfo.py --save-name fullinfo_4_agent_Pendulum-v0_27_04_22 \
  --env Pendulum-v0 --agent-count 4 --eval-interval 500 --batch-size 256 --multi-threading\
