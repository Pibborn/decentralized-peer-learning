...
#SBATCH --job-name=08_04_22_peer_4_agent_Pendulum-v0      # Job name
...
wandb offline
srun python run_peer.py  --save-name peer_4_agent_Pendulum-v0_08_04_22  --env Pendulum-v0  --agent-count 4 \
