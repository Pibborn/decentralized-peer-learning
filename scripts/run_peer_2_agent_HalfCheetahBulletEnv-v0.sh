...
#SBATCH --job-name=peer_2_agent_HalfCheetahBulletEnv-v0      # Job name
...
wandb offline
srun python run_peer.py  --save-name peer_2_agent_HalfCheetahBulletEnv-v0  --job_id %j --env HalfCheetahBulletEnv-v0  --agent-count 2 \
