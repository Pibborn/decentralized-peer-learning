...
#SBATCH --job-name=dictator_3_agent_Pendulum-v0      # Job name
...
#SBATCH --time=3:00:00           # Run time (hh_mm_ss) - 30 seconds
...
wandb offline
srun python run_dicator_new.py  --save-name dictator_new_3_agent_Pendulum-v0  --job_id %j --env Pendulum-v0  --agent-count 3 \
 --eval-interval 500 --batch-size 256 --buffer-size 1_000_000 --steps 20_000 --buffer-start-size 100 --learning_rate 1e-3 --sample_actions
