...
#SBATCH --job-name=14_05_22_dictator_new_4_agent_HalfCheetahBulletEnv-v0      # Job name
...
wandb offline
srun python run_dictator_new.py --save-name dictator_new_4_agent_HalfCheetahBulletEnv-v0_14_05_22 \
