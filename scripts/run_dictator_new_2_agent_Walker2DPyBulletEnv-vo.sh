...
#SBATCH --job-name=dictator_new_2_agent_Walker2DPyBulletEnv-v0      # Job name
...
wandb offline
srun python run_dicator_new.py  --save-name dictator_new_2_agent_Walker2DPyBulletEnv-v0  --job_id %j --env Walker2DPyBulletEnv-v0  --agent-count 2 \
