...
#SBATCH --job-name=dictator_2_agent_Pendulum-v0      # Job name
...
wandb offline
srun python run_dicator_new.py  --save-name dictator_new_2_agent_Pendulum-v0  --job_id %j --env Pendulum-v0  --agent-count 2 \
