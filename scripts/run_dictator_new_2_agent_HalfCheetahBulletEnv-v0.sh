...
#SBATCH --job-name=dictator_new_2_agent_HalfCheetahBulletEnv-v0      # Job name
...
wandb offline
srun python run_dicator_new.py  --save-name dictator_new_2_agent_HalfCheetahBulletEnv-v0  --job_id %j --env HalfCheetahBulletEnv-v0  --agent-count 2 \
