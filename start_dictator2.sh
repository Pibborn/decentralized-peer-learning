...
#SBATCH --job-name=dictator2       # Job name
...
srun python DDPG/pfrl/dictator.py --save-name="dictator2" --seed=102 --agent-count=4 --use-trust=0 --use-critic=0 --use-agent-value=0 --use-trust-buffer=0 --load=0  --peer-learning=0 --gpu=-1
