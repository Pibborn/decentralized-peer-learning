...
#SBATCH --job-name=main3       # Job name
...
srun python DDPG/pfrl/main.py --save-name="main3" --seed=103 --agent-count=4 --use-trust=0 --use-critic=0 --use-agent-value=0 --use-trust-buffer=0 --load=0  --peer-learning=0 --gpu=-1
