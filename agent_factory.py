...
def get_td3_agent(obs_space, action_space, args, rbuf=None):
...
def get_sac_agent(obs_space, action_space, args, rbuf=None):
    obs_size = obs_space.low.size
    action_size = action_space.low.size
    ...
    if args.use_prio:
        rbuf = pfrl.replay_buffers.PrioritizedReplayBuffer(
            ...
            alpha=0.5,
            beta0=0.4,
            num_steps=1,  # args.n_step_return,
...
def get_ddpg_agent(obs_space, action_space, args, rbuf=None):
    obs_size = obs_space.low.size
    action_size = action_space.low.size
