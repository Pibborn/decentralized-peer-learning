...
#SBATCH --job-name=run_peer_4_agent_change_learning_rate_sr_1_HalfCheetahBulletEnv-v0     # Job name
...
#SBATCH -C anyarch
#SBATCH -o output_8_06_22/\%x_\%j.out
#SBATCH -e output_8_06_22/\%x_\%j.err
...
srun python run_peer.py --save-name $SLURM_JOB_NAME \
  --job_id $SLURM_JOB_ID --env HalfCheetahBulletEnv-v0 --agent-count 4 --batch-size 256 --buffer-size 1_000_000 \
  --steps 1_000_000 --buffer-start-size 10_000  --gamma 0.98 --gradient_steps 8 --tau 0.02 --train_freq 8 \
