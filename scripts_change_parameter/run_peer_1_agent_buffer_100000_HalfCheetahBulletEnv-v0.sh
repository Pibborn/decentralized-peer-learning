...
#SBATCH --job-name=peer_1_agent_buffer_100000_HalfCheetahBulletEnv-v0      # Job name
...
srun python run_peer.py --save-name $SLURM_JOB_NAME \
  --job_id $SLURM_JOB_ID --env HalfCheetahBulletEnv-v0 --agent-count 1 --batch-size 256 --buffer-size 100_000 \
