...
#SBATCH --job-name=run_peer_4_agent_individual_learning_rate_sr_5_HalfCheetahBulletEnv-v0     # Job name
...
srun python run_peer.py --save-name $SLURM_JOB_NAME \
  ...
  --net-arch 50  50 --learning_rate 9.0e-4  8.0e-4 7.3e-4 6.5e-4 --switch-ratio 5
