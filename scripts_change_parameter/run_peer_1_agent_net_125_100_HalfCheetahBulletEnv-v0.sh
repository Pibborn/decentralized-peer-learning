...
#SBATCH --job-name=run_peer_1_agent_net_125_100_HalfCheetahBulletEnv-v0.sh     # Job name
...
srun python run_peer.py --save-name $SLURM_JOB_NAME \
  --job_id $SLURM_JOB_ID --env HalfCheetahBulletEnv-v0 --agent-count 1 --batch-size 256 --buffer-size 300_000 \
