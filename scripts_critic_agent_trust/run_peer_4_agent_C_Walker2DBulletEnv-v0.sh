...
#SBATCH --job-name=09_05_22_peer_4_agent_C_Walker2DBulletEnv-v0      # Job name
...
wandb offline
srun python run_peer.py  --save-name peer_4_agent_C_Walker2DBulletEnv-v0_09_05_22  \
  ...
  --seed 0 --use-critic True --use-agent-value False --use-trust False --peers-sample-with-noise False