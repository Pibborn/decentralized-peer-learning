...
#SBATCH --job-name=11_05_22_peer_4_agent_AT_HalfCheetahBulletEnv-v0      # Job name
...
wandb offline
srun python run_peer.py --save-name peer_4_agent_AT_HalfCheetahBulletEnv-v0_11_05_22 \
  ...
  --seed $SLURM_JOB_ID --use-critic False --use-agent-value True --use-trust True --peers-sample-with-noise False
