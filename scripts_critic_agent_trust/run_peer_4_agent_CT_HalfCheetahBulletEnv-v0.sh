...
#SBATCH --job-name=11_05_22_peer_4_agent_CT_HalfCheetahBulletEnv-v0      # Job name
...
wandb offline
srun python run_peer.py --save-name peer_4_agent_CT_HalfCheetahBulletEnv-v0_11_05_22 \
  ...
  --seed $SLURM_JOB_ID --use-critic True --use-agent-value False --use-trust True --peers-sample-with-noise False
