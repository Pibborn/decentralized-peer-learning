...
#SBATCH --job-name=11_05_22_peer_4_agent_only_peer_ReacherBulletEnv-v0      # Job name
...
srun python run_peer.py --save-name $SLURM_JOB_NAME \
  --job_id $SLURM_JOB_ID --env ReacherBulletEnv-v0 --agent-count 1 --batch-size 256 --buffer-size 300_000 \
  ...
  --switch-ratio 0 --sample_random_actions True --follow-steps 10
