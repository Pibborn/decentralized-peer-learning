...
#SBATCH --job-name=11_05_22_peer_4_agent_CAT_LunarLanderContinuous-v2      # Job name
...
wandb offline
srun python run_peer.py --save-name peer_4_agent_CAT_LunarLanderContinuous-v2_11_05_22 \
  --job_id $SLURM_JOB_ID --env LunarLanderContinuous-v2 --agent-count 4 --batch-size 256 --buffer-size 1_000_000 \
  --steps 500_000 --buffer-start-size 10_000 --learning_rate 7.3e-4 --gamma 0.99 --gradient_steps 1 --tau 0.01 --train_freq 1 \
