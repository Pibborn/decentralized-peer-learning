...
#SBATCH --job-name=11_05_22_peer_4_agent_CAT_ReacherBulletEnv-v0      # Job name
...
wandb offline
srun python run_peer.py --save-name peer_4_agent_CAT_ReacherBulletEnv-v0_11_05_22 \
  --job_id $SLURM_JOB_ID --env ReacherBulletEnv-v0 --agent-count 4 --batch-size 256 --buffer-size 300_000 \
