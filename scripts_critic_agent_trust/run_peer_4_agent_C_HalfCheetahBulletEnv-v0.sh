...
#SBATCH --job-name=09_05_22_peer_4_agent_HalfCheetahBulletEnv-v0      # Job name
...
wandb offline
srun python run_peer.py --save-name peer_4_agent_C_HalfCheetahBulletEnv-v0_09_05_22 \
