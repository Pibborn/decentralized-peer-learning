...
#SBATCH --job-name=peer_4_agent_net_50_50_buffer_10000_HalfCheetahBulletEnv-v0      # Job name
...
srun python run_peer.py --save-name $SLURM_JOB_NAME \
  --job_id $SLURM_JOB_ID --env HalfCheetahBulletEnv-v0 --agent-count 4 --batch-size 256 --buffer-size 10_000 \
