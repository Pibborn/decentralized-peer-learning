...
#SBATCH --job-name=peer_1_agent_HopperPyBulletEnv-v0_11_05_22      # Job name
...
srun python run_peer.py --save-name $SLURM_JOB_NAME \
  --job_id $SLURM_JOB_ID --env HopperPyBulletEnv-v0 --agent-count 1 --batch-size 256 --buffer-size 300_000 \
