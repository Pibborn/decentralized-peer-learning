...
#SBATCH --job-name=09_05_22_peer_4_agent_T_Walker2DBulletEnv-v0      # Job name
...
wandb offline
srun python run_peer.py  --save-name peer_4_agent_T_Walker2DBulletEnv-v0_09_05_22  \
  ...
  --seed 0 --use-critic False --use-agent-value False --use-trust True --peers-sample-with-noise False