...
#SBATCH --job-name=11_05_22_peer_4_agent_T_HalfCheetahBulletEnv-v0      # Job name
...
wandb offline
srun python run_peer.py --save-name peer_4_agent_T_HalfCheetahBulletEnv-v0_11_05_22 \
