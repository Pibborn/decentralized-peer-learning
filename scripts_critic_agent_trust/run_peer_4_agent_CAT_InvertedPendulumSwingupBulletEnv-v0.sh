...
#SBATCH --job-name=11_05_22_peer_4_agent_CAT_InvertedPendulumSwingupBulletEnv-v0      # Job name
...
wandb offline
srun python run_peer.py --save-name peer_4_agent_CAT_InvertedPendulumSwingupBulletEnv-v0_11_05_22 \
  --job_id $SLURM_JOB_ID --env InvertedPendulumSwingupBulletEnv-v0 --agent-count 4 --batch-size 256 --buffer-size 300_000 \
  --steps 300_000 --buffer-start-size 10_000 --learning_rate 7.3e-4 --gamma 0.98 --gradient_steps 8 --tau 0.02 --train_freq 8 \
