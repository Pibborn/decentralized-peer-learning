...
#SBATCH --job-name=09_05_22_peer_4_agent_CAT_Walker2DBulletEnv-v0      # Job name
...
#SBATCH -C anyarch
#SBATCH -o output_09_05_22/\%x_\%j.out
#SBATCH -e output_09_05_22/\%x_\%j.err
...
wandb offline
srun python run_peer.py  --save-name peer_4_agent_CAT_Walker2DBulletEnv-v0_09_05_22  \
  --job_id %j --env Walker2DBulletEnv-v0 --agent-count 4 --batch-size 256 --buffer-size 300_000 --steps 400_000 \
  --buffer-start-size 10000 --learning_rate 7.3e-4 --gamma 0.98 --gradient_steps 64 --tau 0.02 --train_freq 64 \
  --seed 0 --use-critic True --use-agent-value True --use-trust True --peers-sample-with-noise False