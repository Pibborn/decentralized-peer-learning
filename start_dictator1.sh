...
srun python dictator.py --save-name="dictator1" --seed=101 --agent-count=4 --use-trust=0 --use-critic=0 --use-agent-value=0 --use-trust-buffer=0 --load=0  --peer-learning=0 --gpu=-1
